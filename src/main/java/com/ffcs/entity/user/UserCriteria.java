package com.ffcs.entity.user;

import com.ffcs.common.enums.StatusEnum;
import com.ffcs.common.superpage.CriteriaSuper;

import java.util.ArrayList;
import java.util.List;

public class UserCriteria implements CriteriaSuper {
    ...
    protected abstract static class GeneratedCriteria {
        ...
        protected void addStatusCriterion(String condition, Object value, String property) {
            ...
            statusCriteria.add(new Criterion(condition, value, "com.ffcs.common.enums.StatusEnumHandler"));
            allCriteria = null;
        }
        ...
        protected void addStatusCriterion(String condition, StatusEnum value1, StatusEnum value2, String property) {
            ...
            statusCriteria.add(new Criterion(condition, value1, value2, "com.ffcs.common.enums.StatusEnumHandler"));
            allCriteria = null;
        }
