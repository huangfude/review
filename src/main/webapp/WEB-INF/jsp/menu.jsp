            ...
            <div class="row">
                <div class="box col-md-3">
                    <div class="box-inner">
                        ...
                        <div class="box-content">
                        	<shiro:hasPermission name="add:rootMenu">  
                            <p>
                ...
                <div class="box col-md-9">
                    <div class="box-inner"  id="menuListInfo">
                        ...
                        <div class="box-content">
                        	<shiro:hasPermission name="add:menu">
                            	<a id="addMenu" class="btn btn-primary" disabled="disabled">添加菜单</a>
                            </shiro:hasPermission>
                            <shiro:hasPermission name="delete:rootMenu">
                            	<a class="btn btn-danger" id="removeRoot">删除根目录</a>
                            </shiro:hasPermission>
